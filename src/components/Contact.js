...
const Contact = () => {
  ...
  return (
    <div id='contact' className=" flex-grow flex-col flex overflow-hidden h-screen justify-center items-center text-white">

      <div className='w-3/5 flex h-3/4'>
        
        
        <div id="contact-form" className='w-3/5 bg-[#0000003a] h-full'>
          
          <form method='POST' action="https://getform.io/f/8439b9cf-48bb-429f-9e3a-1973f8156046" className='flex flex-col m-8 w-4/5'>
            <div className='pb-4'>
              <p className='text-2xl font-bold inline text-gray-300'>Contact Us</p>
            </div>
            <input className='bg-[#ccd6f6] p-1 text-black' type="text" placeholder='Name' name='name' />
            <input className='my-4 p-1 bg-[#ccd6f6] text-black' type="email" placeholder='Email' name='email' />
            <textarea className='bg-[#ccd6f6] p-1 text-black' name="message" rows="8" placeholder='Message' style={{ resize: "none" }}></textarea>
        ...
        <div id="contact-social" className=' m-5 w-2/5 h-full'>

        <div className='lg:flex flex-col h-full w-full'>
